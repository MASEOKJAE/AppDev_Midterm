            ...
            children: [
              InkWell(
                ...
                onDoubleTap: () {
                  ...
                  if (_isFavorited) { 
                    Provider.of<FavoriteModel>(context, listen: false).add(hotel);
                  } else { 
                    Provider.of<FavoriteModel>(context, listen: false).remove(hotel);
                  }
                },
                child: Hero(
              ...
              Positioned( // 오른쪽 상단에 하트 아이콘 배치
                  right :10 ,
                  top   :10 ,
                  child :
                    Icon(Icons.favorite ,color:_isFavorited ?Colors.red :Colors.white),
              )
            ],
          ),
          Padding(
